...
p <- ggplot(projections, aes(x = year, y = most.likely, ymin = minimum, ymax = maximum,
  ...
  scale_linetype_manual( values = c('Limit warming to 2C' = 1,
                         ...
                         breaks=c('Limit warming to 2C',
                                  ...
                                  'Historical'),
                         guide = guide_legend(reverse=TRUE)) +
  scale_fill_manual( values = c('Limit warming to 2C' = alpha("black", 0.5),
                                'INDC (conditional)' = alpha("black", 0.3),
                                'INDC (unconditional)' = alpha("black", 0.3),
                                'Current Policy'= alpha("black", 0.1),
                     ...
                     breaks=c('Limit warming to 2C',
                              ...
                              'Historical'),
                     guide = guide_legend(reverse=TRUE)) +
  scale_color_manual( values = c('Limit warming to 2C' = "black",
                                 'INDC (conditional)' = "black",
                                 'INDC (unconditional)' = "black",
                                 'Current Policy'= "black",
...
png(width=1024 * 2, height=768 * 2, filename = "paris_gap.png")
plot(p)
dev.off()
